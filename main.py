...
def main():
    ...
    for i in range(N_FOLDS):
        ...
        for k in range(1, N_EPOCHS+1):
            ...
            _, _, _, _, total_loss, age_loss, sex_loss, avg_age_diff, avg_sex_diff= train_ut.validate(model, eval_gen, age_criterion, sex_criterion)
            print("{}/{} EPOCH : TOTAL LOSS = {} / AGE_LOSS = {} / SEX_LOSS = {} / AVG_AGE_DIFF = {} / AVG_SEX_DIFF = {}".format(k,N_EPOCHS,total_loss,age_loss, sex_loss, avg_age_diff, avg_sex_diff), file=log_file)
